function CommunityTab() {
  return (
    <div className="flex-col mb-[73px]">
      <p>
        📍 모임을 만들거나 참여하기 전에 꼭&nbsp;
        <span className="text-suldak-mint-500 underline">커뮤니티 가이드</span>
        를 확인해주세요 📍
      </p>
      <div className="mt-[12px] text-suldak-gray-700 bg-suldak-mint-50 rounded-[16px] p-[16px] mb-[24px]">
        <ul className="space-y-2 list-disc pl-[20px]">
          ...
          <li className="indent">서로에 대한 기본적인 예의는 꼭 지켜주세요</li>
          <li className="indent">
            모임 중에 발생하는 금전적인 문제를 포함한 다른 기타 문제는 호스트와
            참여 멤버끼리 해결해야 해요
          </li>
          <li className="indent">
