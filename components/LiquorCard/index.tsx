...
/** 카드 컴포넌트 */
const LiquorCard = ({ imgUrl, liquorId, liquorDetail, liquorAbv, name }: CardProps) => {
  return (
    <div className="w-full rounded-2xl flex items-center gap-3.5 h-card text-black bg-white shadow-suldak-card p-[18px]">
      ...
      <div className="flex flex-col gap-1.5">
        <div className="flex flex-col gap-0.5">
          <p className="text-suldak-orange-500 text-xs font-medium">ALC 10~15%</p>
          <p className="text-suldak-gray-900 text-base font-semibold">{name || 'Name None'}</p>
